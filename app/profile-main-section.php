<style>
form#profileForm input,form#profileForm textarea { border:1px solid #999; } form#profileForm select, form#profileForm active{border:1px solid #ccc;}
</style>
<div class="header">
<div class="container ">
...
<button type="submit" name="profileUpdate" value="Update Profile" class="btn btn-success" >Update Profile</button>
</div>
