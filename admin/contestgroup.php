...
$contests_SQL = "SELECT * FROM `contests_groups` WHERE `contest_id`='$id'";
...
<html>
  <head>
    <meta charset="UTF-8">
    <title>ADMIN | Contest Groups</title>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Contest Groups List</li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title" style="line-height:30px;">Contest Groups List</h3>
				...
				<?php if(count($contests_results)>0) { ?>
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tr>
                      <td><?php echo $contests_result['group_unique_id']; ?></td>
                      <td><?php echo $contests_result['group_name']; ?></td>
                      <td><?php echo $contests_result['group_member_count']; ?></td>
                      <td>
					  <?php if($contests_result['group_status']==1) { ?>
					  <span class="label label-success">ACTIVE</span>
					  <?php } else if($contests_result['group_status']==0) { ?>
